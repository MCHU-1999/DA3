...
from .planarsplatting import export_to_planarsplatting
...
def export(
    ...
    **kwargs,
    ...
    if export_format == "planarsplatting":
        export_to_planarsplatting(prediction, export_dir, **kwargs.get(export_format, {}))
