...
def synthesize_intrinsics(
    ...
    Example:
        K = synthesize_intrinsics(1920, 1080, fov_deg=75)  # landscape: hfov=75
        K = synthesize_intrinsics(1080, 1920, fov_deg=75)  # portrait: vfov=75
    """
    cx = width / 2.0
    cy = height / 2.0
...
if __name__ == "__main__":
    ...
    # Create synthetic intrinsics for outdoor scene (70° horizontal FOV)
